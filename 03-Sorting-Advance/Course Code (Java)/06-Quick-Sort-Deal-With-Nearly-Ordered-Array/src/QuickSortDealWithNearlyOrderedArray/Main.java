package QuickSortDealWithNearlyOrderedArray;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SortTestHelper.testSort("QuickSortDealWithNearlyOrderedArray.MergeSort", arr1);
        SortTestHelper.testSort("QuickSortDealWithNearlyOrderedArray.QuickSort", arr2);
